...
public class CreateShirtRequestValidation : AbstractValidator<CreateShirtCommand>
{
    public CreateShirtRequestValidation()
    {
        ...
        RuleFor(x => x.ShirtCategory).IsInEnum().WithMessage("ShirtCategory must be even numbers.");
    }
}